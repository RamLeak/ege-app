...
/**
 * Phase 4 Stage P4-D (Convention #72) — русские тренажёры, источник `corpus.db`
 * через парсеры `extract_paronyms.py`, `extract_pleonasms.py`,
 * `extract_collocations.py`. JSON-файлы в assets.
 * Phase 4 Stage P4-D6 (Convention #90) — multi-choice grammar (№8) полностью удалён.
 */
...
// Phase 4 Stage P4-D6 (Convention #90) — `GrammarOption` + `GrammarErrorItem` +
// `GrammarErrorsRepository` удалены вместе с UI multi-choice тренажёра №8.
