...
| B | Главный экран — цитата дня, предиктор балла, радар (4 стиля), streak, быстрый тренажёр | ⏸ Waiting |
| C | Полноценный журнал — ошибки, статистика, user_attempts, история проб | ⏸ Waiting |
