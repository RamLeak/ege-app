...
| 2 | Android MVP — навигация, экран задачи, проверка ответа, тренажёры русского №4 и №9-12 | 🟡 In progress (Stage 1-4 ✅, Stage 5 — финал) |
...
| 5 | Полировка (светлая тема, дополнительная анимация, финал) | ⏸ Waiting |
