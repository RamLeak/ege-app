...
| 3 | Главный экран — предиктор балла, радар, streak, журнал ошибок, прогресс-бары | 🟡 In progress (Stage A ✅) |
...
| D | Уведомления — пробники / streak / напоминания через WorkManager | ⏸ Waiting |
